...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <c:if test="${not empty dropDownSearchList}">
                <h4 class="text-center mb-4 mt-5 fw-semibold" style="color: orange">Tổng hợp sách ${requestScope.dropDownsearchKey}</h4>

                <div class="container mt-4">

                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
                        <c:forEach var="book" items="${dropDownSearchList}">
                            <div class="col">
        ...
        <div>
            ...
            <c:if test="${not empty allBooks}">
                <h4 class="text-center mb-4 mt-5 fw-semibold" style="color: orange">All Book</h4>
                <div class="container mt-4">
