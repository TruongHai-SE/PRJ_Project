 ...
 * @author HONG MINH
 */
public class SystemConfigListController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<SystemConfig> systemConfigList = scDao.systemConfigList();
        request.setAttribute("systemConfigList", systemConfigList);
        request.getRequestDispatcher("SystemConfigList.jsp").forward(request, response);
    } 
